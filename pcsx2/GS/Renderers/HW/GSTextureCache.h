...
public:
	...
	public:
		Target(GSRenderer* r, const GIFRegTEX0& TEX0, bool depth_supported);
...
protected:
	...
	static void PreloadTexture(const GIFRegTEX0& TEX0, const GIFRegTEXA& TEXA, GSRenderer* renderer, bool paltex, GSTexture* tex, u32 level);
