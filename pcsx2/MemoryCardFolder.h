...
public:
	...
	static void WriteIndex(std::string folderName, MemoryCardFileEntry* const entry, MemoryCardFileMetadataReference* const parent);
...
private:
	...
	void WriteMetadata(std::string_view& folderName, const MemoryCardFileMetadataReference* fileRef);
};
