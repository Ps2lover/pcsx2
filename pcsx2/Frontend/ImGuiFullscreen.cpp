...
HostDisplayTexture* ImGuiFullscreen::GetCachedTexture(const std::string& name)
{
...
void ImGuiFullscreen::SetLoadTextureFunction(LoadTextureFunction callback)
{
...
bool ImGuiFullscreen::MenuButtonFrame(const char* str_id, bool enabled, float height, bool* visible, bool* hovered, ImRect* bb,
...
bool ImGuiFullscreen::ToggleButton(const char* title, const char* summary, bool* v, bool enabled, float height, ImFont* font,
	ImFont* summary_font)
{
	ImRect bb;
	bool visible, hovered;
...
bool ImGuiFullscreen::MenuButtonWithValue(const char* title, const char* summary, const char* value, bool enabled, float height,
...
void ImGuiFullscreen::DrawFileSelector()
{
			...
			ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove))
	{
		...
		if (!s_file_selector_current_directory.empty())
		{
			MenuButton(fmt::format(ICON_FA_FOLDER_OPEN "  {}", s_file_selector_current_directory).c_str(), nullptr,
...
static ImGuiFullscreen::ChoiceDialogOptions s_choice_dialog_options;
static ImGuiFullscreen::ChoiceDialogCallback s_choice_dialog_callback;
...
void ImGuiFullscreen::ClearState()
{
