...
public:
	ControllerBindingWidget(QWidget* parent, u32 port);
	~ControllerBindingWidget();

	__fi const std::string& getConfigSection() { return m_config_section; }
	__fi const std::string& getControllerType() { return m_controller_type; }
